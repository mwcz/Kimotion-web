define(["exports", "module", "mods/fish/FishSprite", "mods/fish/utils.js", "mods/fish/consts.js"], function (exports, module, _modsFishFishSprite, _modsFishUtilsJs, _modsFishConstsJs) {
    ...
    var PurpleFishSprite = (function (_FishSprite) {
        _inherits(PurpleFishSprite, _FishSprite);

        function PurpleFishSprite() {
            _classCallCheck(this, PurpleFishSprite);

            _FishSprite.call(this);

            this.type = _modsFishConstsJs.PURPLE;
        ...
        return PurpleFishSprite;
    })(_FishSprite2["default"]);

    module.exports = PurpleFishSprite;
});
